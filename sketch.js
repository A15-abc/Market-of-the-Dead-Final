...
function preload() {
    ...
    //winsound = loadSound("sounds/jump.mp3")
    //lostsound = loadSound("sounds/die.mp3")
    eatsound = loadSound("sounds/eating.mp3")
...
function setup() {
    ...
    playbutton.position(width / 2.5, height - (height / 5))
    ...
    mutebutton.position(playbutton.x - width / 3, height / 2 + 130)
    mutebutton.size(260, 300)
    mutebutton.hide()


    infobutton = createImg("info.gif")
    infobutton.position(50, 0)
    infobutton.size(width / 1.5, height)
    infobutton.hide()
